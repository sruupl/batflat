...
class Site extends SiteModule
{
    ...
    {
        if ($this->settings('settings', 'autodetectlang') == '1' && empty(parseURL(1))
            && !isset($_SESSION['langswitcher']['detected'])) {
            $detedcted = false;
    ...
    private function insertSwitcher()
    {
        return $this->draw('switcher.html', ['languages' => $this->getLanguages()]);
    }

    protected function getLanguages($selected = null, $attr = 'selected', $all = false)
    {
