...
class Admin extends AdminModule
{
    ...
    public function getAdd()
    {
        ...
        if (!empty($e = getRedirectData())) {
            $this->assign['form'] = [
                ...
                'desc' => isset_or($e['desc'], ''), 'content' => isset_or($e['content'], ''),
    ...
    public function postSave($id = null)
    {
        ...
        if (empty($_POST['slug'])) {
            $_POST['slug'] = createSlug($_POST['title'], $_POST['lang']);
        } else {
            $_POST['slug'] = createSlug($_POST['slug'], $_POST['lang']);
        }

        if ($id != null &&
            $this->db('pages')
            ->where('slug', $_POST['slug'])->where('lang', $_POST['lang'])
